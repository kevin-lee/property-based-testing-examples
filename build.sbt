lazy val root = (project in file("."))
  ...
  , libraryDependencies ++= projectDependencies ++ hedgehogLibs
  )
  ...
  .settings(testFrameworks ++= Seq(TestFramework("hedgehog.sbt.Framework")))


lazy val projectSettings = Seq(
    name := "property-based-testing-examples"
  , version := "0.1.0"
